    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
      <div class="grid grid-cols-1 lg:grid-cols-3 h-[calc(100vh-200px)]">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center justify-between mt-1">
                    <div class="flex items-center space-x-2">
                      ...
                      <span v-if="conversation.isAiHandled" class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800">
                        <CpuChipIcon class="h-3 w-3 mr-1" />
                        IA
                      </span>
                    </div>
                    <span v-if="conversation.unreadCount > 0" class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-red-600 rounded-full">
        ...
        <div class="lg:col-span-2 flex flex-col min-h-0">
          ...
          <div v-else-if="isLoading" class="flex-1 flex items-center justify-center bg-gray-50">
          ...
          <template v-else>
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                  ...
                  >
                    ...
                    {{ selectedConversation.isAiHandled ? 'IA Ativa' : 'IA Inativa' }}
                  </button>
              ...
              >
                ...
                >
                  ...
                  <div class="flex items-center justify-end mt-1">
                    <p :class="[ 'text-xs opacity-75 mr-2', message.direction === 'outbound' ? 'text-green-100' : 'text-gray-500' ]">
                      {{ message.time }}
                    </p>
                    <div v-if="message.direction === 'outbound'" class="flex items-center space-x-1">
                      ...
                      <div v-else-if="message.status === 'delivered' || message.status === 'read'" class="flex">
                        <CheckIcon :class="['h-4 w-4', message.status === 'read' ? 'text-blue-300' : 'opacity-75']" />
                        <CheckIcon :class="['h-4 w-4 -ml-2', message.status === 'read' ? 'text-blue-300' : 'opacity-75']" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="p-4 border-t border-gray-200 bg-white flex-shrink-0">
              <div v-if="filePreviewUrl" class="mb-2 p-2 border rounded-lg relative w-40">
                ...
                <button @click="removeAttachment" class="absolute -top-2 -right-2 bg-gray-700 text-white rounded-full h-6 w-6 flex items-center justify-center hover:bg-red-600 transition-colors">
                  <XMarkIcon class="h-4 w-4" />
                </button>
              </div>
              <div class="flex items-end space-x-2">
                <button @click="triggerFileInput" class="p-2 text-gray-400 hover:text-green-600 rounded-lg transition-colors">
                ...
                <div class="flex-1">
                  <textarea
                    ...
                    rows="1"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-green-500 focus:border-green-500 resize-none"
                ...
                <button
                  ...
                  class="bg-green-600 hover:bg-green-700 disabled:bg-gray-300 text-white p-2 rounded-lg transition-colors flex items-center justify-center"
